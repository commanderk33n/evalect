...
Once the questions are populated, you can return to root_path ie by clicking Question Groups and share distribute answer url so that others can answer the questions populated.
...
- edit Question is buggy  "no route error"
- translation
- clearly arranged views for questions, create, result etc.
